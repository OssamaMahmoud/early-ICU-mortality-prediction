...
SELECT intime, icud.subject_id, icud.hadm_id, icud.icustay_id, icustay_seq, los_hospital, los_icu, icud.hospital_expire_flag, 
	...
	SPECIMEN, abgfd.AADO2_MAX, abgfd.BASEEXCESS_MAX, abgfd.BICARBONATE_MAX,
	abgfd.TOTALCO2_MAX, abgfd.CARBOXYHEMOGLOBIN_MAX, abgfd.CHLORIDE_MAX,
	abgfd.CALCIUM_MAX, abgfd.GLUCOSE_MAX, abgfd.HEMATOCRIT_MAX, abgfd.HEMOGLOBIN_MAX, 
	...
	abgfd.POTASSIUM_MAX, abgfd.REQUIREDO2_MAX, abgfd.SODIUM_MAX, abgfd.TEMPERATURE_MAX,
	abgfd.TIDALVOLUME_MAX, abgfd.VENTILATIONRATE_MAX, abgfd.VENTILATOR_MAX, abgfd.AADO2_MIN,
	abgfd.BASEEXCESS_MIN, abgfd.BICARBONATE_MIN, abgfd.TOTALCO2_MIN, abgfd.CARBOXYHEMOGLOBIN_MIN, abgfd.CHLORIDE_MIN,
	abgfd.CALCIUM_MIN, abgfd.GLUCOSE_MIN, abgfd.HEMATOCRIT_MIN, abgfd.HEMOGLOBIN_MIN, 
	...
	abgfd.POTASSIUM_MIN, abgfd.REQUIREDO2_MIN, abgfd.SODIUM_MIN, abgfd.TEMPERATURE_MIN,
	...
	lfd.BANDS_min, lfd.BANDS_max, lfd.BICARBONATE_min, lfd.BICARBONATE_max,
	lfd.BILIRUBIN_min, lfd.BILIRUBIN_max, lfd.CREATININE_min, lfd.CREATININE_max, 
	lfd.CHLORIDE_min, lfd.CHLORIDE_max, lfd.GLUCOSE_min, lfd.GLUCOSE_max, 
...
FROM 
	...
	vitalsfirstday vfd, aggbloodgasfirstday abgfd,
	labsfirstday lfd, gcsfirstday gcs, oasis, sapsii


where 
	icud.icustay_id=labsfirstday.icustay_id AND 
